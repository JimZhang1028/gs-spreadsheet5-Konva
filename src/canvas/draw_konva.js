...
class Draw extends Konva.Layer{
  constructor(el, width, height) {
    ...
    */
    ...
    //console.log("class name: " + this.getClassName());


  }

  resize(width, height) {
    // console.log("draw resize");
    // console.log('dpr:', dpr);
    super.size({ width: width, height: height});
